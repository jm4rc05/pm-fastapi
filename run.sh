...
function login() {
    ...
    export authorization_token=`curl -X POST ${endpoint_app}token -s -H 'Content-Type: application/x-www-form-urlencoded' --data-urlencode 'username=admin' --data-urlencode 'password='f67d7cce569f3e1a3c259c15bce31abad42b414b625577a72fa5922f0607c143 | jq -r '.token'`
}
